...
const en = {
  ...
  newTaskSheet: {
    ...
    subtypeGuess: (label: string) => `My guess: ${label}`,
  ...
  notificationPreferences: {
    ...
    eodLabel: 'End-of-day summary',
    eodSublabel: 'Remind you about unfinished location tasks.',
    streakLabel: 'Streak at risk',
    streakSublabel: 'Warn you at 8 PM when your streak is at risk.',
    weeklyLabel: 'Weekly summary',
    weeklySublabel: 'Sunday-night summary of your week.',
    reengageLabel: 'Re-engagement reminders',
    reengageSublabel: 'A nudge after 3 days away from the app.',
    exitPromptLabel: 'Exit prompt',
    exitPromptSublabel: 'Ask whether you completed a task after leaving a marked place.',
    achievementNudgesLabel: 'Achievement nudges',
    achievementNudgesSublabel: 'Notify you when you are 1 step away from unlocking a badge.',
...
const ptPT: typeof en = {
  ...
  newTaskSheet: {
    ...
    subtypeGuess: (label: string) => `O meu palpite: ${label}`,
